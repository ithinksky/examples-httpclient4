package com.ithinksky.util.http.pool;
...
public class UserAgentPoolUtilTest {
    ...
    public void testUserAgentPool() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            UserAgentPoolUtil.add(new UserAgentPoolUtil.UserAgentBean(list.get(RandomUtil.getRandomIntWithIn(0, list.size())), UserAgentPoolUtil.UserAgentBean.TYPE_MOBILE));
        }
